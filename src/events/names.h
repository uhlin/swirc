...
int	event_names_htbl_modify_owner   (const char *nick, const char *channel, bool is_owner);
int	event_names_htbl_modify_superop (const char *nick, const char *channel, bool is_superop);
